...
/** Horizontal sliders — filter / adjust controls. */
export function FilterSlidersIcon({ size = 16, className }: IconProps) {
  return (
    <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.2"
      strokeLinecap="round" width={size} height={size} className={className}>
      <line x1="3" y1="5" x2="15" y2="5"/>
      <circle cx="7" cy="5" r="1.35" fill="currentColor" stroke="none"/>
      <line x1="3" y1="9" x2="15" y2="9"/>
      <circle cx="11" cy="9" r="1.35" fill="currentColor" stroke="none"/>
      <line x1="3" y1="13" x2="15" y2="13"/>
      <circle cx="6" cy="13" r="1.35" fill="currentColor" stroke="none"/>
    </svg>
  );
}
